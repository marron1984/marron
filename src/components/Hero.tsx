  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main catchphrase — line-by-line clip reveal */}
        <h1 className="mb-6">
          {catchphraseLines.map((line, lineIdx) => (
            <motion.span
              key={lineIdx}
              initial={{ clipPath: "inset(0 100% 0 0)" }}
              animate={{ clipPath: "inset(0 0% 0 0)" }}
              transition={{ duration: 1.2, delay: 0.4 + lineIdx * 0.2, ease: EASE }}
              className="block text-[clamp(2.5rem,8vw,7rem)] font-black leading-[1] tracking-tight text-foreground"
            >
              {line}
            </motion.span>
          ))}
