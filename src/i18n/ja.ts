...
const ja: SiteLocale = {
  ...
  portfolio: [
    ...
    },
    {
      ...
      longDescription:
        "独自ブランドでの宿泊施設の運営を軸に、大手ホテルグループのマスターフランチャイザーとしても事業展開。法隆寺・四天王寺・成田山新勝寺・三井寺等の有名寺院と協業した宿坊和風ホテル事業も展開し、底地購入から建築、ブランド構築、オペレーションまで一貫した事業開発と多拠点展開を実現。",
  ...
  timeline: [
    ...
    },
    {
      ...
      description:
        "株式会社AA（8月〜）、株式会社あん（9月〜）を創業。DHPグループ（リゾート開発・ケアマネジメント・都市開発・ホスピタリティ・FUDOKI・100doors・ウニクラフト・ミッチーノ）、AAウズベキスタン、IPLPF等、12の事業体を横断的に経営。介護・ホスピタリティ・テクノロジー・第一次産業・国際協力・飲食の6業種を統括。",
